...
- How will we review code when it’s generated faster than a human can read it? For example below where OpenHands has generated a huge number of branches. ![The OpenHands agent has created so many fixes, the branches are becoming unmanageable](/blog/images/openhands-branches.png)
...
If that excites you, we’d love to hear from you: [founders@engines.dev](founders@engines.dev)
